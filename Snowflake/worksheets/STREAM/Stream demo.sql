...
merge into members m
  using (
    ...
    on m.id = s.id
  when matched then update set m.fee = 100;
...
select to_timestamp('1698244815569000000');  -- 2020-04-11 05:15:47.496

select to_timestamp('1698245165033000000');  -- 2023-10-25 14:46:05.033f
